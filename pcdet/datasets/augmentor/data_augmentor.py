...
class DataAugmentor(object):
    ...
    def random_world_flip(self, data_dict=None, config=None):
        ...
        for cur_axis in config['ALONG_AXIS_LIST']:
            ...
            # ==========================================================
            # �� 新增：记录翻转矩阵 (Reverse Augmentation Tracking)
            # ==========================================================
            if enable:
                flip_mat = np.eye(4, dtype=np.float32)
                if cur_axis == 'x':
                    flip_mat[1, 1] = -1.0  # 沿 X 轴翻转，Y 坐标变号
                elif cur_axis == 'y':
                    flip_mat[0, 0] = -1.0  # 沿 Y 轴翻转，X 坐标变号
                data_dict['aug_matrix'] = np.dot(flip_mat, data_dict.get('aug_matrix', np.eye(4, dtype=np.float32)))
            # ==========================================================
    ...
    def random_world_rotation(self, data_dict=None, config=None):
        ...
        # ==========================================================
        # �� 新增：记录旋转矩阵 (Reverse Augmentation Tracking)
        # ==========================================================
        ...
        data_dict['aug_matrix'] = np.dot(rot_mat, data_dict.get('aug_matrix', np.eye(4, dtype=np.float32)))
        # ==========================================================
    ...
    def random_world_scaling(self, data_dict=None, config=None):
        ...
        # ==========================================================
        # �� 新增：记录缩放矩阵 (Reverse Augmentation Tracking)
        # ==========================================================
        scale_mat = np.diag([noise_scale, noise_scale, noise_scale, 1.0]).astype(np.float32)
        data_dict['aug_matrix'] = np.dot(scale_mat, data_dict.get('aug_matrix', np.eye(4, dtype=np.float32)))
        # ==========================================================
    ...
    def forward(self, data_dict):
        ...
        """
        # ========================================================
        # �� 新增：在每次数据增强流水线开始前，初始化单位矩阵
        # ========================================================
        data_dict['aug_matrix'] = np.eye(4, dtype=np.float32)
