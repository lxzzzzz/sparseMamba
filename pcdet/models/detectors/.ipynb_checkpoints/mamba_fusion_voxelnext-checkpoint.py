...
class MambaFusionVoxelNeXt(Detector3DTemplate):
    """
    基于 VoxelNeXt 全稀疏架构的 Detector
    融合了 Mamba 长序列特征与图像融合，并支持辅助门控 Loss 计算
    """
    ...
    def forward(self, batch_dict):
        # 1. 逐个运行模块 (VFE -> Sparse Backbone (带Mamba和融合) -> VoxelNeXtHead)
    ...
    def get_aux_loss(self, batch_dict):
        ...
        目标：让稀疏特征网络在 Mamba 融合前学会分辨前景与背景
        """
