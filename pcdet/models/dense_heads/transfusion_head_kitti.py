...
class TransFusionHeadKITTI(nn.Module):
    """
    TransFusionHead adapted for KITTI/DAIR-V2X (No Velocity, 3 Classes)
    """
    def __init__(
        self,
        model_cfg, input_channels, num_class, class_names, grid_size, point_cloud_range, voxel_size, predict_boxes_when_training=True,
    ):
        super(TransFusionHeadKITTI, self).__init__()
        ...
        self.dataset_name = self.model_cfg.TARGET_ASSIGNER_CONFIG.get('DATASET', 'kitti')
        ...
        # KITTI Code Size: x, y, z, w, l, h, sin, cos (No Velocity)
        self.code_size = 8 
    ...
    def predict(self, inputs):
        ...
        # --- Cleaned up logic: Removed nuScenes/Waymo specific indices ---
        # For standard detection, we simply apply basic heatmap NMS
