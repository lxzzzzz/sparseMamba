...
def apply_dataset_preset(args):
    ...
    if args.dataset_preset == 'v2x_xian_2hz':
        ...
        preset_override(args, 'rescue_center_gate', 28.0, '--rescue_center_gate')
        preset_override(args, 'fallback_center_gate', 22.0, '--fallback_center_gate')
        ...
        preset_override(args, 'u3d_high', 0.70, '--u3d_high')
        preset_override(args, 'u2d_high', 0.70, '--u2d_high')
        preset_override(args, 'rescue_min_visual_conf', 0.20, '--rescue_min_visual_conf')
